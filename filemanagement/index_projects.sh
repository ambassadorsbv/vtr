...
# Script to index all projects and their size for cleanup
...
du -kd1 /HEIMDALL/PROJECTS/p20 | sed $'s/[[:blank:]]/,/;s/\/.*\///;s/[[:space:]]/-/g;s/\///g;/\,\./d' | sort -nr >> /HEIMDALL/LIBRARY/studio/servsizes/all_servers/heimdall/heimdall_2020_$datetime.csv

du -kd1 /HEIMDALL/PROJECTS/p19 | sed $'s/[[:blank:]]/,/;s/\/.*\///;s/[[:space:]]/-/g;s/\///g;/\,\./d' | sort -nr >> /HEIMDALL/LIBRARY/studio/servsizes/all_servers/heimdall/heimdall_2019_$datetime.csv
...
for latest in /HEIMDALL/LIBRARY/studio/servsizes/all_servers/{work,rushes,heimdall}/*_$datetime.csv; do
